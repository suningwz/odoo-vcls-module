...
class PayrollExport(models.Model):
    ...
    def create(self,vals):
        ...
        export.employee_ids = self.env['hr.employee'].with_context(active_test=False).search([('employee_type','=','internal'),('company_id.id','=',company_id),('employee_start_date','<=',export.end_date),('employee_start_date','!=',False),'|',('employee_end_date','=',False),('employee_end_date','>=',export.end_date)])
